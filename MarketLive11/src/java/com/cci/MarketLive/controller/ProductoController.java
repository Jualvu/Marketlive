...
public class ProductoController implements Serializable {
    ...
    public void saveProducto(){
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Proyecto añadido"));
        */
    }
    ...
    public void updateProducto(){
        /*
        ServicioProyecto servicioProyecto = new ServicioProyecto();
        servicioProyecto.actualizar(selectedProyecto, this.selectedProyecto.getId());
    ...
    public void deleteProducto(){
        ...
        boolean proyectoLibre = servicioTarea.consultarTareas(this.selectedProyecto.getId());
        */
    }
